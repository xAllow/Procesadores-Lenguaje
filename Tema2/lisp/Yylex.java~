 ...
 * from the specification file <tt>sumaLisp.lex</tt>
 */
class Yylex {
  ...
  private static final String ZZ_CMAP_PACKED = 
    ...
    "\1\6\1\7\1\0\1\10\1\0\1\11\2\0\12\12\113\0\1\2"+
    "\32\0\1\1\u15df\0\1\1\u097f\0\13\1\35\0\2\2\5\0\1\1"+
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 17: break;
          case 9: 
            { return new Yytoken(Yytoken.ENTERO, Integer.parseInt(yytext()));
            } 
            // fall through
          case 18: break;
          default:
